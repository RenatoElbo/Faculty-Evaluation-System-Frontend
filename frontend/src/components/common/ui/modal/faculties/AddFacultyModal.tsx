                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {[
                            ...
                            >
                                ...
                                <input
                                    type="text"
                                    value={newFaculty[key as keyof typeof newFaculty] as string}
                                    onChange={(e) => {
                                        setNewFaculty({
                                            ...newFaculty,
                                            [key]: e.target.value
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <TagMultiSelect
                            ...
                            selected={newFaculty.section_handle}
                            setSelected={(values) =>
                                setNewFaculty({
                                    ...newFaculty,
                        ...
                        <TagMultiSelect
                            ...
                            selected={newFaculty.subject_handle}
                            setSelected={(values) =>
                                setNewFaculty({
                                    ...newFaculty,
