...
export default function AddDeanModal({
    isOpen,
    onClose,
    newDean,
    title,
            ...
            <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-xl p-6">
                ...
                <div className="flex flex-col gap-1.5 mb-5">
                    ...
                    <input
                        ...
                        value={newDean}
                        onChange={(e) => {
                            setNewDean(e.target.value);
                            setError("");
                        }}
                        placeholder="e.g. Dr. Juan Dela Cruz"
                        className={`w-full px-4 py-3 rounded-xl border text-sm text-gray-900 outline-none transition-all focus:border-violet-400 focus:ring-2 focus:ring-violet-100 ${
                            error
